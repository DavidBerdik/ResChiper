...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/release-0.1.0--rc7.3-%23C6782A.svg" alt="Release 0.1.0-rc7.3">
</p>
...
plugins {
    ...
    id("io.github.goldfish07.reschiper") version "0.1.0-rc7.3"
}
```
...
buildscript {
    ...
    dependencies {
        classpath("io.github.goldfish07.reschiper:plugin:0.1.0-rc7.3")
    }
}
```
